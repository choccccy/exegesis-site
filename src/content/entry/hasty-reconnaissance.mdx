...
5 teams ventured into the depths at Delta Site: Bennu, Sarus, Amur, Osprey, and Kūaka. They all had a simple objective; find the source of the primion beam. Slow, careful exploration was eschewed for a mad dash over the course of 2 weeks, fueled by friendship, love, and duty to everyone slowly dying aboard Nysa's Wake in the meantime.

![break](../../assets/exegesis_thumb.svg)

`T+ 15h from primion beam initiation`

Sarus is assigned to a path with fractal tunnels; as the largest expeditionary team, they intended to brute force their way through. Several explorers go MIA, seemingly lost to shifts in the tunnels. A Sarus sub-team discover a very direct route which covers over 100 kilometers. While many of the other branches narrowed down to holes which appeared to be just a single hydrogen atom wide, this route's throat was a full 9 meters wide. It's the best start yet discovered, so the expedition continues on (thruster assisted) foot from there, since most exploration craft can't fit.

![break](../../assets/exegesis_thumb.svg)

`T+ 85h from primion beam initiation`

Kūaka, meanwhile, navigates a massive ocean full of a solution of water and a metamaterial comprised of strange metallic nanoparticles, which become increasingly opaque to electromagnetic radiation as it gets hotter. Progress is slow, as there are huge masses in the fluid, further confounding navigation. Kūaka takes advantage of this fluid being enourmously effective as a thermal conductor, allowing for fast movement if they're careful, although an early attempt to use this fluid as propulsion reaction mass results in an explosion comprable to a warhead. Further research reveals that, when in the presence of amorphous hydrogen and oxygen (such as when water is ionized by a thruster), the nanoparticles are converted with seemingly impossible efficiency into a plasma. This causes a chain reaction which is eventually contained by the conductive nature of the fluid as it becomes a larger and larger sphere, but the pressure and thermal effects on anything nearby resemble an instantanious, tiny star.
...
The SAR team gets an alert to a confusing SOS; just a single ping from Bennu, and then nothing. They head to the tunnel and review the logs; Bennu was travelling at 93 m/s on thrusters when they all just go dark for no apparent reason. Initial, battery powered recon probes are able to get to Bennu, who are banged up, but appear to be intact. SAR sends in a heavier, fusion powered platform to fetch their frames, and as it approaches the downed team, it also instantly powers down. After some experimentation, the SAR team realizes that there is a zone where the weak nuclear force appears to be nearly 730x weaker, measured by testing beta decay of a sample as it passes over the threshold of the zone. After requisitioning some batteries, fetching Bennu is trivial, although the team is rattled; if the zone had the opposite effect, Bennu Team and the rest of the tunnel would be destroyed by the force of a tiny star.

Despite the hazard, the tunnel is nearly linear. Battery packs and autonomous platforms are gathered from Delta Site and moved to the zone to allow teams to make the sprint across.
...
Despite the expedition's casualties, Kūaka Team finally finds the source of the beam within the subterranean sea; a massive, hot, perfectly spherical structure, utilizing the strange solution as coolant.