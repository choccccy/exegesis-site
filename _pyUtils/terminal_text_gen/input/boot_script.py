events = [
    {
        'id': 'boot-post',
        'lines': [
            {'prompt': "onye_Nchọgharị > ", 'text': "boot-up sequence initiated"},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "boot-up sequence initiated"},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "Brain Crystal: ✅"},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "Brain-body bus: ✅"},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "Fusion Core: ✅"},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "Cooling Systems: ⚠️ Water tanks at 28.73%. Refill soon."},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "External Sensor Suite: ✅"},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "Skeletal Actuators: ❌ Arm 00 (left) joint 3 (elbow) requires 8.3% more torque to actuate than baseline calibration. Seek maintainence or replacement."},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "Proptioceptive Sensors: ✅"},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "Touch sensors: ✅"},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "RCS: ✅"},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "Communication Array: ❌ Receiving antenna 01 (right) automatically adjusted to 300.0% (maximum) gain to maintain parity with receiving antenna 00 (left). Seek maintainence or replacement."},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "Magnetic Grip Pads: ✅"},
            {'prompt': "onye_Nchọgharị/POST > ", 'text': "Magnetic Holsters: ✅"},
        ],
    },
    {
        'id': 'boot-hud',
    ...
    {
        'id': 'boot-visible-cam',
        'lines': [{'prompt': "onye_Nchọgharị/sensors/cameras/visible > ", 'text': "enabled"}]
    },
    {
        'id': 'boot-doc-chat',
        'lines': [
